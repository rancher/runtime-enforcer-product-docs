...
single version, following the https://semver.org/[Semantic Versioning] specification.
...
https://helm.sh/docs/topics/charts/#the-chartyaml-file[`Chart.yaml`]
